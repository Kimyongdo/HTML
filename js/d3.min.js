...
(function (t, n) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        function s(t, n) {
            function e(e) {
                var o = null == s
                    ...
                    E = T.select("text");
                M = M.merge(
                    M.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")
                ),
                T = T.merge(S),
                N = N.merge(S.append("line").attr("stroke", "#000").attr(r + "2", d * l).attr(
                    v + "1",
                    .5
                ).attr(v + "2", .5)),
                E = E.merge(
                    S.append("text").attr("fill", "#000").attr(r, d * g).attr(v, .5).attr(
                        "dy",
                        t === xf
                            ? "0em"
                            : t === wf
                ...
                e !== w && (
                    ...
                    N = N.transition(e),
                    E = E.transition(e),
                    k = k.transition(e).attr("opacity", Tf).attr("transform", function (t) {
        ...
        function m(t) {
            return function () {
                var n = this.ownerDocument,
                    e = this.namespaceURI;
                return e === Sf && n.documentElement.namespaceURI === Sf
                    ? n.createElement(t)
        ...
        function N(t, n, e) {
            var r = qf.hasOwnProperty(t.type)
                ? M
                : T;
        ...
        function L(t, n, e, r, i, o, u) {
            ...
            for (a = 0; a < l; ++a) 
                (c = n[a]) && (
                    p[a] = s = Wf + u.call(c, c.__data__, a, n),
                    s in f
                        ? i[a] = c
                        : f[s] = c
                );
            for (a = 0; a < h; ++a) 
                s = Wf + u.call(t, o[a], a, o),
                (c = f[s])
        ...
        function G(t, n) {
            for (var e = W(t), r = -1, i = n.length; ++r < i;) 
                e.add(n[r])
        }
        function J(t, n) {
            for (var e = W(t), r = -1, i = n.length; ++r < i;) 
        ...
        function Tt(t) {
            ...
            (n = Ll.exec(t))
                ? (
                    n = parseInt(n[1], 16),
                    new At(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1)
                )
                : (n = Rl.exec(t))
                    ? kt(parseInt(n[1], 16))
                    : (n = ql.exec(t))
                        ? new At(n[1], n[2], n[3], 1)
                        : (n = Ul.exec(t))
                            ? new At(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1)
                            : (n = Dl.exec(t))
                                ? St(n[1], n[2], n[3], n[4])
                                : (n = Ol.exec(t))
                                    ? St(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4])
                                    : (n = Fl.exec(t))
                                        ? Ct(n[1], n[2] / 100, n[3] / 100, 1)
                                        : (n = Il.exec(t))
                                            ? Ct(n[1], n[2] / 100, n[3] / 100, n[4])
                                            : Yl.hasOwnProperty(t)
                                                ? kt(Yl[t])
                                                : "transparent" === t
        ...
        function Nt(t) {
            ...
            t
                ? (t = t.rgb(), new At(t.r, t.g, t.b, t.opacity))
                : new At
        }
        function Et(t, n, e, r) {
        ...
        function qt(t) {
            ...
            return new Dt(
                116 * u - 16,
                500 * (o - u),
                200 * (u - Ot((.0193339 * e + .119192 * r + .9503041 * i) / Vl)),
                t.opacity
            )
        }
        function Ut(t, n, e, r) {
        ...
        function Wt(t, n, e, r, i) {
            var o = t * t,
                u = o * t;
            return (
                (1 - 3 * t + 3 * o - u) * n + (4 - 6 * o + 3 * u) * e + (1 + 3 * t + 3 * o - 3 * u) * r + u * i
            ) / 6
        }
        function Zt(t, n) {
            return function (e) {
            ...
            return "none" === t
                ...
                : (
                    oh || (
                        ...
                        uh = document.documentElement,
                        ah = document.defaultView
                    ),
                    oh.style.transform = t,
                    t = ah.getComputedStyle(uh.appendChild(oh), null).getPropertyValue("transform"),
                    uh.removeChild(oh),
                    t = t.slice(7, -1).split(","),
                    Eh(+t[0], + t[1], + t[2], + t[3], + t[4], + t[5])
                )
        }
        function on(t) {
            return null == t
                ? Nh
                : (
                    ch || (ch = document.createElementNS("http://www.w3.org/2000/svg", "g")),
                    ch.setAttribute("transform", t),
                    (t = ch.transform.baseVal.consolidate())
                        ? (t = t.matrix, Eh(t.a, t.b, t.c, t.d, t.e, t.f))
                        : Nh
                )
        }
        function un(t, n, e, r) {
            ...
            function wn(t) {
                if (!Ih) {
                    ...
                    var n = t - Xh;
                    n > 24
                        ? (t < 1 / 0 && (Yh = setTimeout(mn, n)), Bh && (Bh = clearInterval(Bh)))
                        : (Bh || (Hh = Xh, Bh = setInterval(xn, jh)), Ih = 1, Wh(mn))
                }
            }
            function Mn(t, n) {
                var e = t.__transition;
                if (!e || !(e = e[n]) || e.state > Kh) 
                    throw new Error("too late");
                return e
            }
            function Tn(t, n) {
                var e = t.__transition;
                if (!e || !(e = e[n]) || e.state > np) 
                    throw new Error("too late");
                return e
            }
            function kn(t, n) {
            ...
            function ze(n) {
                ...
                function r() {
                    ...
                    n
                        ? (
                            t.selectAll(".selection").style("display", null).attr("x", n[0][0]).attr("y", n[0][1]).attr("width", n[1][0] - n[0][0]).attr("height", n[1][1] - n[0][1]),
                ...
                function u() {
                    ...
                    function o() {
                        ...
                        switch (m = O[0] - D[0], x = O[1] - D[1], S) {
                            case ud:
                            case od:
                                N && (m = Math.max(P - l, Math.min(R - v, m)), h = l + m, _ = v + m),
                                E && (x = Math.max(L - p, Math.min(q - g, x)), d = p + x, y = g + x);
                                break;
                            case ad:
                                N < 0
                                    ? (m = Math.max(P - l, Math.min(R - l, m)), h = l + m, _ = v)
                                    : N > 0 && (m = Math.max(P - v, Math.min(R - v, m)), h = l, _ = v + m),
                                E < 0
                                    ? (x = Math.max(L - p, Math.min(q - p, x)), d = p + x, y = g)
                                    : E > 0 && (x = Math.max(L - g, Math.min(q - g, x)), d = p, y = g + x);
                                break;
                            case cd:
                                N && (
                                    h = Math.max(P, Math.min(R, l - m * N)),
                                    _ = Math.max(P, Math.min(R, v + m * N))
                                ),
                                E && (
                        ...
                        _ < h && (
                            ...
                            h = _,
                            _ = t,
                            k in pd && Y.attr("cursor", hd[k = pd[k]])
                        ),
                        y < d && (
                            E *= -1,
                            t = p,
                            ...
                            d = y,
                            y = t,
                            k in dd && Y.attr("cursor", hd[k = dd[k]])
                        ),
                    ...
                    function u() {
                        ...
                        Y.attr("cursor", hd.overlay),
                        A.selection && (z = A.selection),
                        Ne(z) && (A.selection = null, r.call(T)),
                        F.end()
                    }
                    function a() {
                    ...
                    if (f.apply(this, arguments)) {
                        ...
                        if (t.event.touches) 
                            I
                                .on("touchmove.brush", e, !0)
                                .on("touchend.brush touchcancel.brush", u, !0);
                        else {
                            var B = bl(t.event.view)
                ...
                o.prototype = {
                    ...
                    emit: function (t) {
                        E(
                            new rd(e, t, n.output(this.state.selection)),
                            l.apply,
                            l,
            ...
            function Qe(t) {
                var n,
                    ...
                    l = -(1 / 0);
                for (e = 0; e < o; ++e) 
                    isNaN(r = +this._x.call(null, n = t[e])) || isNaN(i = +this._y.call(null, n)) || (
                        u[e] = r,
                        a[e] = i,
                        r < c && (c = r),
                        r > f && (f = r),
            ...
            function pr(n) {
                return Ev = zv(n),
                t.format = Ev.format,
                t.formatPrefix = Ev.formatPrefix,
                Ev
            }
            function dr() {
                this.reset()
            ...
            function qr(t, n) {
                ...
                if (Wv) {
                    ...
                    f
                        ? t < Xv
                            ? Yr(Yv, t) > Yr(Yv, jv) && (jv = t)
                            : Yr(t, jv) > Yr(Yv, jv) && (Yv = t)
                        : jv >= Yv
                            ? (t < Yv && (Yv = t), t > jv && (jv = t))
                            : t > Xv
                                ? Yr(Yv, t) > Yr(Yv, jv) && (jv = t)
            ...
            function Wr(t, n) {
                ...
                var e = T_(n),
                    ...
                    o = A_(n),
                    u = M_(
                        z_((u = l_ * o - h_ * i) * u + (u = h_ * r - f_ * o) * u + (u = f_ * i - l_ * r) * u),
                        f_ * r + l_ * i + h_ * o
                    );
                Qv += u,
                e_ += u * (f_ + (f_ = r)),
            ...
            function si(t, n, e, r) {
                ...
                return function (u) {
                    ...
                    function p() {
                        v && (d(y, m), x && M && N.rejoin(), v.push(N.result())),
                        E.point = c,
                        M && S.lineEnd()
                    }
                    function d(o, u) {
                        ...
                        if (_ && g.push([o, u]), T) 
                            ...
                            var c = [
                                    b = Math.max(lg, Math.min(fg, b)),
                                    w = Math.max(lg, Math.min(fg, w))
                                ],
                                s = [
                                    o = Math.max(lg, Math.min(fg, o)),
                                    u = Math.max(lg, Math.min(fg, u))
                                ];
                            ag(c, s, t, n, e, r)
                                ? (
            ...
            function wi() {
                ...
                function n() {
                    return Gs(k_(o / _) * _, i, _)
                        .map(h)
                        .concat(Gs(k_(s / g) * g, c, g).map(p))
                        .concat(Gs(k_(r / d) * d, e, d).filter(function (t) {
                            return b_(t % _) > d_
                        }).map(f))
                        .concat(Gs(k_(a / v) * v, u, v).filter(function (t) {
                            return b_(t % g) > d_
                        }).map(l))
                }
                var e,
                        ...
                        b_(c - v_) < d_
                            ? (t.point(
                                ...
                                r = (r + u) / 2 > 0
                                    ? __
                                    : -__
                            ), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0)
                            : i !== a && c >= v_ && (
                                b_(e - i) < d_ && (e -= i * d_),
                                b_(o - a) < d_ && (o -= a * d_),
                                r = Vi(e, r, o, u),
            ...
            function Vi(t, n, e, r) {
                var i,
                    ...
                    u = A_(t - e);
                return b_(u) > d_
                    ? w_((A_(n) * (o = T_(r)) * A_(e) - A_(r) * (i = T_(n)) * A_(t)) / (i * o * u))
                    : (n + r) / 2
            }
            function $i(t, n, e, r) {
                var i;
                ...
                function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
                    ...
                    if (m > 4 * n && v--) {
                        var x = u + h,
                            ...
                            z = y * A - g * C;
                        (
                            z * z / m > n || b_((g * A + y * C) / m - .5) > .3 || u * h + a * p + c * d < ry
                        ) && (
                            e(r, i, o, u, a, c, N, E, k, x /= M, b /= M, w, v, _),
                            _.point(N, E),
                            e(N, E, k, x, b, w, s, f, l, h, p, d, v, _)
                        )
                    }
                }
                return function (n) {
                    ...
                    function s() {
                        e(g, y, _, m, x, b, l, h, f, p, d, v, ey, n),
                        w.lineEnd = u,
                        u()
                    }
                    var f,
                ...
                n.clipExtent = function (t) {
                    return arguments.length
                        ? (
                            N = null == t
                                ? (S = l = h = p = null, kg)
                                : si(S = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]),
                            o()
                        )
                        : null == S
                            ? null
                ...
                o.clipExtent = function (t) {
                    return arguments.length
                        ? (
                            null == t
                                ? f = e = r = i = null
                                : (f = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]),
                            n()
                        )
                        : null == f
                            ? null
            ...
            function Xo(t) {
                ...
                t : for (a = 3; a < i; ++a) {
                    ...
                    for (
                        ...
                        (d = jo(r, o, u)) < h && (n = r, h = d);
                    e = n.next
                }
                for (n = [e._], r = e; (r = r.next) !== e;) 
                    n.push(r._);
                for (r = qy(n), a = 0; a < i; ++a) 
                    n = t[a],
                    n.x -= r.x,
                    n.y -= r.y;
                return r.r
                ...
                for (var n, e, r, i, o, u = new au(t, 0), a = [u]; n = a.pop();) 
                    if (r = n._.children) 
                        for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) 
                            a.push(e = n.children[i] = new au(r[i], i)),
                            e.parent = n;
            return (u.parent = new au(null, 0)).children = [u],
                u
            }
            ...
            function lu(t) {
                for (var n = t.length, e = [
                    ...
                    for (; r > 1 && em(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0;) 
                        --r;
                    e[r++] = i
                }
                return e.slice(0, r)
            ...
            function du(t) {
                for (; t._start = t._waiting && t._active < t._size;) {
                    var n = t._ended + t._active,
                        ...
                        r = e.length - 1,
                        i = e[r];
                    e[r] = vu(t, n), = t._waiting + 1, = t._active + 1,
                    e = i.apply(null, e),
                    t._tasks[n] && (t._tasks[n] = e || am)
                }
            }
            function vu(t, n) {
                return function (e, r) {
            ...
            function Lu(t) {
                ...
                t.nice = function (e) {
                    var i = n(),
                        ...
                        s = r(a, c, u);
                    return s && (
                        s = r(Math.floor(a / s) * s, Math.ceil(c / s) * s, u),
            ...
            function Wu() {
                ...
                return t.domain = function (i) {
                    return arguments.length
                        ? (n = km.call(i), r = Math.min(n.length, e.length - 1), t)
                        : n.slice()
                },
                t.range = function (i) {
                    return arguments.length
                        ? (e = km.call(i), r = Math.min(n.length, e.length - 1), t)
                        : e.slice()
                },
                t.invertExtent = function (t) {
                    var r = e.indexOf(t);
            ...
            function na(t) {
                ...
                function e(t, n) {
                    return function (e) {
                        ...
                        return "Z" in i
                            ? (i.H += i.Z / 100 | 0, i.M += i.Z % 100, Ku(i))
                            : n(i)
                    }
                }
                function r(t, n, e, r) {
                ...
                function u(t, n, e) {
                    ...
                    return r
                        ? (t.w = L[r[0].toLowerCase()], e + r[0].length)
                        : -1
                }
                function a(t, n, e) {
            ...
            function Za(n) {
                return Lx = na(n),
                t.timeFormat = Lx.format,
                t.timeParse = Lx.parse,
                t.utcFormat = Lx.utcFormat,
                t.utcParse = Lx.utcParse,
                Lx
            }
            function Ga(t) {
            ...
            function us(t, n, e, r) {
                for (var i, o = Nw.length; o--;) 
                    os(i = Nw[o], t, n, e, r) && is(i, t, n, e, r) && (
                        Math.abs(i[0][0] - i[1][0]) > Cw || Math.abs(i[0][1] - i[1][1]) > Cw
                    ) || delete Nw[o]
            }
            function as(t) {
                return kw[t.index] = {
            ...
            function hs(t, n, e, r) {
                ...
                for (i = 0; i < _; ++i) 
                    if (o = kw[i]) {
                        ...
                        for (a = 0, s = c.length; a < s;) 
                            ...
                            l = f[0],
                            h = f[1],
                            (Math.abs(d - l) > Cw || Math.abs(v - h) > Cw) && (c.splice(a, 0, Nw.push(es(
                                u,
                                p,
                                Math.abs(d - t) < Cw && r - v > Cw
                                    ? [
                                        t,
                                        Math.abs(l - t) < Cw
                                            ? h
                ...
                for (i = 0; i < _; ++i) 
                    (o = kw[i]) && (o.halfedges.length || delete kw[i])
            }
            function ps() {
                Jc(this),
            ...
            function ms(t) {
                ...
                for (
                    var c = o;
                    c.circle && Math.abs(e - c.circle.x) < Cw && Math.abs(r - c.circle.cy) < Cw;
                ) 
                    o = c.P,
                    a.unshift(c),
                    ys(c),
                ...
                for (
                    var s = u;
                    s.circle && Math.abs(e - s.circle.x) < Cw && Math.abs(r - s.circle.cy) < Cw;
                ) 
                    u = s.N,
                    a.push(s),
                    ys(s),
                ...
                for (f = 1; f < l; ++f) 
                    s = a[f],
                    c = a[f - 1],
                    rs(s.edge, c.site, s.site, i);
                c = a[0],
                s = a[l - 1],
                s.edge = ns(c.site, s.site, null, i),
                ds(c),
                ds(s)
            }
            function xs(t) {
                for (var n, e, r, i, o = t[0], u = t[1], a = Tw._; a;) 
                    if ((r = bs(a, u) - o) > Cw) 
                        a = a.L;
                    else {
                        if (!((i = o - ws(a, u)) > Cw)) {
                ...
                if (Tw.insert(n, c), n || e) {
                    if (n === e) 
                        ...
                        void ds(e);
                    if (!e) 
                        return void(c.edge = ns(n.site, c.site));
                    vs(n),
                    vs(e);
                    var s = n.site,
                        f = s[0],
                    ...
                    rs(e.edge, s, d, x),
                    c.edge = ns(s, t, null, x),
                    e.edge = ns(t, d, null, x),
                    ds(n),
                    ds(e)
                }
            }
            ...
            function ks(t, n) {
                var e,
                    ...
                    o = t
                        .sort(Ts)
                        .pop();
                for (Nw = [], kw = new Array(t.length), Tw = new Gc, Sw = new Gc;;) 
                    if (i = Mw, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) 
                        o[0] === e && o[1] === r || (xs(o), e = o[0], r = o[1]),
                        o = t.pop();
                    else {
                        if (!i) 
                            break;
            ...
            var Ls = function (t, n) {
                ...
                Os = function (t, n) {
                    null == n && (n = e);
                    for (var r = 0, i = t.length - 1, o = t[0], u = new Array(
                        i < 0
                            ? 0
                            : i
                    ); r < i;) 
                ...
                Bs = function (t, n) {
                    ...
                    if (null == n) 
                        for (; ++a < i;) 
                            isNaN(e = Ys(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
                else 
                        for (; ++a < i;) 
                            isNaN(e = Ys(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
                if (c > 1) 
                        return u / (c - 1)
                },
                js = function (t, n) {
                ...
                of = function (t, n, e) {
                    return t = $s
                        ...
                        .sort(Ls),
                    Math.ceil(
                        (e - n) / (2 * (rf(t, .75) - rf(t, .25)) * Math.pow(t.length, -1 / 3))
                    )
                },
                uf = function (t, n, e) {
                ...
                sf = function (t, n) {
                    ...
                    if (null == n) 
                        for (; ++o < i;) 
                            isNaN(e = Ys(t[o])) || r.push(e);
                else 
                        for (; ++o < i;) 
                            isNaN(e = Ys(n(t[o], o, t))) || r.push(e);
                ...
                _f = function (t) {
                    if (!(o = t.length)) 
                        return [];
                    for (var n = -1, e = lf(t, i), r = new Array(e); ++n < e;) 
                ...
                Yf = function (t) {
                    ...
                    for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i) 
                        for (
                            ...
                            (o = a[f]) && (u = t.call(o, o.__data__, f, a)) && (
            ...
            var bl = function (t) {
                ...
                wl = function (t) {
                    return "string" == typeof t
                        ? new dt([document.querySelectorAll(t)], [document.documentElement])
                        : new dt([
                            null == t
                                ? []
                                : t
            ...
            var El = function () {
                    ...
                    function e() {
                        if (!f && l.apply(this, arguments)) {
                            ...
                            n && (
                                bl(t.event.view).on("mousemove.drag", r, !0).on("mouseup.drag", i, !0),
                                Sl(t.event.view),
                                _t(),
                                s = !1,
                                n("start")
                    ...
                    function i() {
                        bl(t.event.view).on("mousemove.drag mouseup.drag", null),
                        gt(t.event.view, s),
                        kl(),
                        v.mouse("end")
                    }
                    function o() {
                        if (l.apply(this, arguments)) {
                            var n,
                                ...
                                o = r.length;
                            for (n = 0; n < o; ++n) 
                                (e = c(r[n].identifier, i, Ml, this, arguments)) && (_t(), e("start"))
                        }
                    }
                    function u() {
                        var n,
                    ...
                    function c(e, r, i, o, u) {
                        ...
                        if (E(new yt(n, "beforestart", a, e, g, f[0], f[1], 0, 0, l), function () {
                            return null != (t.event.subject = a = p.apply(o, u)) && (
                                c = a.x - f[0] || 0,
                                s = a.y - f[1] || 0,
                                !0
                            )
                            ...
                            return function t(h) {
                                ...
                                E(
                                    new yt(n, h, a, e, p, f[0] + c, f[1] + s, f[0] - d[0], f[1] - d[1], l),
                                    l.apply,
                                    l,
                                    [h, o, u]
                                )
            ...
            Al(Dt, Ut, wt(Mt, {
                ...
                rgb: function () {
                    ...
                    e = Vl * Ft(e),
                    new At(
                        It(3.2404542 * n - 1.5371385 * t - .4985314 * e),
                        It(-.969266 * n + 1.8760108 * t + .041556 * e),
                        It(.0556434 * n - .2040259 * t + 1.0572252 * e),
                        this.opacity
                    )
                }
            })),
            Al(Ht, jt, wt(Mt, {
                brighter: function (t) {
                    return new Ht(this.h, this.c, this.l + 18 * (
                        null == t
                            ? 1
                            : t
                    ), this.opacity)
            ...
            var oh,
                ...
                Mh = function (t, n) {
                    var e,
                        r,
                        i,
                        o = bh.lastIndex = wh.lastIndex = 0,
                        u = -1,
                        a = [],
                        c = [];
                    for (t += "", n += ""; (e = bh.exec(t)) && (r = wh.exec(n));) 
                        (i = r.index) > o && (
                            i = n.slice(o, i),
                            a[u]
                                ? a[u] += i
                ...
                Xh = 0,
                Vh = 0,
                $h = "object" == typeof performance && performance.now
                    ? performance
                    : Date,
                Wh = "function" == typeof requestAnimationFrame
            ...
            var Zh = function (t, n, e) {
                ...
                sp = function (t, n) {
                    ...
                    if (t += "", arguments.length < 2) {
                        for (var r, i = kn(this.node(), e).tween, o = 0, u = i.length; o < u; ++o) 
                            if ((r = i[o]).name === t) 
                                return r.value;
                    return null
                    }
                ...
                xp = function (t) {
                    ...
                    for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u) 
                        for (
                            ...
                            (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && (
                                "__data__" in a && (c.__data__ = a.__data__),
                                l[h] = c,
                                up(l[h], n, e, h, l, kn(a, e))
                            );
            ...
            var Cp = function t(n) {
                    ...
                    function r(t) {
                        return (
                            (t = 2 * t - 1) < 0
                                ...
                                : 2 - n * Math.pow(2, -10 * t) * Math.sin((i + t) / e)
                        ) / 2
                    }
                    var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= Wp);
                    return r.amplitude = function (n) {
                ...
                Kp = function (t) {
                    ...
                    for (var r = this._groups, i = r.length, o = 0; o < i; ++o) 
                        for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) 
                            (u = a[s]) && up(u, t, n, s, a, e || be(u, n));
                return new Kn(r, this._parents, t, n)
                };
            vt.prototype.interrupt = cp,
            vt.prototype.transition = Kp;
            var td = [null],
                nd = function (t, n) {
                    var e,
                        r,
                    ...
                    if (null === this._x1) 
                        ...
                        if (Math.abs(f * a - c * s) > 1e-6 && i) {
                            var h = e - o,
                                ...
                                m = y / g,
                                x = y / _;
                            Math.abs(m - 1) > 1e-6 && (this._ += "L" + (
                                t + m * s
                            ) + "," + (
                                n + m * f
                            )),
                            this._ += "A" + i + "," + i + ",0,0," + +(f * h > s * p) + "," + (
                                this._x1 = t + x * a
                            ) + "," + (
                                this._y1 = n + x * c
                            )
            ...
            var Cd = function () {
                function t() {
                    ...
                    if (
                        ...
                        u.moveTo(p, d),
                        u.arc(0, 0, f, l, h),
                        l === _ && h === g || (u.quadraticCurveTo(0, 0, v * yd(_), v * md(_)), u.arc(0, 0, v, _, g)),
            ...
            var Ld = function (t) {
                        ...
                        : n
                            ? (
                                i
                                    ? n[l] = i
                                    : delete n[l],
                                (p = n[0] || n[1] || n[2] || n[3]) && p === (n[3] || n[2] || n[1] || n[0]) && !p.length && (
                                    e
                                        ? e[h] = p
                                        : this._root = p
                                ),
                ...
                ov = function (t) {
                    var n,
                        ...
                        c = this._root;
                    for (
                        c && a.push(new tv(c, this._x0, this._y0, this._x1, this._y1));
                        n = a.pop();
                    ) 
                        if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
                            var s = (r + o) / 2,
                                f = (i + u) / 2;
                            (e = c[3]) && a.push(new tv(e, s, f, o, u)),
                            (e = c[2]) && a.push(new tv(e, r, f, s, u)),
                            (e = c[1]) && a.push(new tv(e, s, i, o, f)),
                            (e = c[0]) && a.push(new tv(e, r, i, s, f))
                        }
                    return this
                },
                uv = function (t) {
                    var n,
                        ...
                        r = [];
                    for (
                        this._root && e.push(new tv(this._root, this._x0, this._y0, this._x1, this._y1));
                        n = e.pop();
                    ) {
                        var i = n.node;
                        if (i.length) {
                            var o,
                                ...
                                f = (u + c) / 2,
                                l = (a + s) / 2;
                            (o = i[0]) && e.push(new tv(o, u, a, f, l)),
                            (o = i[1]) && e.push(new tv(o, f, a, c, l)),
                            (o = i[2]) && e.push(new tv(o, u, l, f, s)),
                            (o = i[3]) && e.push(new tv(o, f, l, c, s))
                        }
                        r.push(n)
                    }
                    for (; n = r.pop();) 
            ...
            sv.copy = function () {
                var t,
                    n,
                    e = new rr(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
                    r = this._root;
                if (!r) 
                    return e;
                if (!r.length) 
            ...
            var fv,
                lv = function (t) {
                    function n() {
                        ...
                        for (var n, r, c, s, f, l, h, p = i.length, d = 0; d < a; ++d) 
                            for (r = er(i, or, ur).visitAfter(e), n = 0; n < p; ++n) 
                                c = i[n],
                                l = o[c.index],
                                h = l * l,
                                s = c.x + c.vx,
                    ...
                    function e(n) {
                        for (var e = 0, r = t.length; e < d; ++e) 
                            for (var i, o, c, s, l, h, p, v = 0; v < r; ++v) 
                                ...
                                o = i.source,
                                c = i.target,
                                s = c.x + c.vx - o.x - o.vx || Zd(),
                                l = c.y + c.vy - o.y - o.vy || Zd(),
                                h = Math.sqrt(s * s + l * l),
                                h = (h - a[v]) / h * n * u[v],
                                s *= h,
                                l *= h,
                    ...
                    function r() {
                        if (c) {
                            ...
                            for (n = 0, s = new Array(r); n < h; ++n) 
                                e = t[n],
                                e.index = n,
                                "object" != typeof e.source && (e.source = cr(p, e.source)),
                                "object" != typeof e.target && (e.target = cr(p, e.target)),
                ...
                bv = function (t, n) {
                    return function (e, r) {
                        for (var i = e.length, o = [], u = 0, a = t[0], c = 0; i > 0 && a > 0 && (
                    ...
                    return o === u
                        ...
                        : o > u
                            ...
                            : o > 0
                                ...
                                : "0." + new Array(1 - o).join("0") + mv(t, Math.max(0, n + o - 1))[0]
                },
                kv = function (t, n) {
                    var e = mv(t, n);
                    if (!e) 
                    ...
                    function n(t) {
                        function n(t) {
                            ...
                            if ("c" === d) 
                                ...
                                t = +t;
                                var b = t < 0;
                                if (t = g(Math.abs(t), p), b && 0 ==+ t && (b = !1), m = (
                                    b
                                        ? "(" === c
                                            ? c
                                            : "-"
            ...
            var Pv = function (t) {
                ...
                Lv = function (t, n) {
                    return Math.max(
                        0,
                        3 * Math.max(-8, Math.min(8, Math.floor(xv(n) / 3))) - xv(Math.abs(t))
                    )
                },
                Rv = function (t, n) {
                    return t = Math.abs(t),
                    n = Math.abs(n) - t,
                    Math.max(0, xv(n) - xv(t)) + 1
                },
                qv = function () {
                    return new dr
                };
            ...
            var Uv,
                ...
                B_ = function (t) {
                    ...
                    if (Hv = jv = -(Yv = Bv = 1 / 0), Zv = [], q_(t, Y_), e = Zv.length) {
                        for (Zv.sort(Br), n = 1, r = Zv[0], o = [r]; n < e; ++n) 
                            i = Zv[n],
                            jr(r, i[0]) || jr(r, i[1])
                                ? (
                                    Yr(r[0], i[1]) > Yr(r[0], r[1]) && (r[1] = i[1]),
                                    Yr(i[0], r[1]) > Yr(r[0], r[1]) && (r[0] = i[0])
                                )
                                : o.push(r = i);
                        for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n) 
                            i = o[n],
                            (a = Yr(r[1], i[0])) > u && (u = a, Yv = i[0], jv = r[1])
                    }
                    return Zv = Gv = null,
                    Yv === 1 / 0 || Bv === 1 / 0
                        ? [
                ...
                H_ = function (t) {
                    Jv = Qv = Kv = t_ = n_ = e_ = r_ = i_ = o_ = u_ = a_ = 0,
                    q_(t, j_);
                    var n = o_,
                        e = u_,
                        r = a_,
            ...
            var $_,
                ...
                ig = function (t) {
                    ...
                    n.invert = function (n) {
                        return n = t.invert(n[0] * x_, n[1] * x_),
                        n[0] *= m_,
                        n[1] *= m_,
                        n
                    },
                ...
                sg = function (t, n, e, r, i) {
                    ...
                    if (t.forEach(function (t) {
                        if (!((n = t.length - 1) <= 0)) {
                            ...
                            a.push(e = new ai(r, t, null, !0)),
                            c.push(e.o = new ai(r, null, e, !1)),
                            a.push(e = new ai(u, t, null, !1)),
                            c.push(e.o = new ai(u, null, e, !0))
                        }
                    }), a.length) {
                        for (c.sort(n), ci(a), ci(c), o = 0, u = c.length; o < u; ++o) 
                            c[o].e = e = !e;
                        for (var s, f, l = a[0];;) {
                            for (var h = l, p = !0; h.v;) 
                                if ((h = h.n) === l) 
                ...
                Eg = {
                    ...
                    polygonEnd: function () {
                        Eg.lineStart = Eg.lineEnd = Eg.point = mr,
                        Sg.add(b_(Ng)),
                        Ng.reset()
                    },
                    result: function () {
                        ...
                        var t = Bg
                            ...
                            : Fg
                                ...
                                : Ug
                                    ...
                                    : [NaN, NaN];
                        return Rg = qg = Ug = Dg = Og = Fg = Ig = Yg = Bg = 0,
                        t
                    }
                };
            Oi.prototype = {
                        ...
                        var p,
                            ...
                            b = {
                                ...
                                polygonEnd: function () {
                                    ...
                                    var t = dg(p, g);
                                    d.length
                                        ? (x || (o.polygonStart(), x = !0), sg(d, Hi, t, e, o))
                                        : t && (
                    ...
                    function i(t) {
                        ...
                        return {
                            ...
                            point: function (l, h) {
                                ...
                                if (
                                    !n && (a = i = v) && t.lineStart(),
                                    v !== i && (p = o(n, d), (cg(n, p) || cg(d, p)) && (d[0] += d_, d[1] += d_, v = r(d[0], d[1]))),
                                    v !== i
                                ) 
                                    f = 0,
                                    v
            ...
            var gy = function () {
                ...
                yy = function () {
                    ...
                    return u = {
                        ...
                        clipExtent: function (i) {
                            return arguments.length
                                ? (
                                    d = null == i
                                        ? (p = n = e = r = null, kg)
                                        : si(p = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]),
                                    t()
                                )
                                : null == p
                                    ? null
                        ...
                        scale: function (n) {
                            return arguments.length
                                ? (h = _o((a = +n) * f, a * l, c, s), t())
                                : a
                        },
                        translate: function (n) {
                            return arguments.length
                                ? (h = _o(a * f, a * l, c = +n[0], s = +n[1]), t())
                                : [c, s]
                        },
                        reflectX: function (n) {
                            return arguments.length
                    ...
                    function t(t) {
                        ...
                        n
                            ...
                            : t
                                ...
                                .eachBefore(Qo(Math.min(e, r) / (2 * t.r))),
                        t
                    }
                    var n = null,
                        e = 1,
                    ...
                    function r(t, n, e) {
                        if (n) {
                            for (
                                ...
                                r > 0 && (iu(uu(a, t, e), t, r), s += r, f += r),
                                l += a.m,
                                s += i.m,
                                h += c.m,
                                f += u.m;
                            a && !ru(u) && (u.t = a, u.m += l - f),
                            i && !eu(c) && (c.t = i, c.m += s - h, e = t)
                        }
                        return e
                    }
                    function i(t) {
                        ...
                        if ((u = t._squarify) && u.ratio === n) 
                            for (var u, a, c, s, f, l = -1, h = u.length, p = t.value; ++l < h;) {
                                for (a = u[l], c = a.children, s = a.value = 0, f = c.length; s < f; ++s) 
                                    a.value += c[s].value;
                                a.dice
                                    ? Iy(a, e, r, i, r += (o - r) * a.value / p)
                                    : $y(a, e, r, e += (i - e) * a.value / p, o),
                                p -= a.value
                            }
                        else 
                            t._squarify = u = su(n, t, e, r, i, o),
                            u.ratio = n
                    }
                    return e.ratio = function (n) {
                        return t(
            ...
            hu.prototype = yu.prototype = {
                ...
                defer: function (t) {
                    ...
                    return n.push(t), = this._waiting + 1,
                    this
                        ._tasks
                        .push(n),
                    pu(this),
                ...
                abort: function () {
                    return null == this._error && _u(this, new Error("abort")),
                    this
                },
                await: function (t) {
                    if ("function" != typeof t || this._call) 
            ...
            var cm = function (t, n) {
                ...
                dm = function (t, n) {
                    ...
                    var r,
                        ...
                        o,
                        u,
                        a = d("beforesend", "progress", "load", "error"),
                        c = Ye(),
                        ...
                        h = 0;
                    if (
                        "undefined" == typeof XDomainRequest || "withCredentials" in s || !/^(http(s)?:)?\/\//.test(t) || (s = new XDomainRequest),
                        "onload" in s
                ...
                Cm = function (n, e, i) {
                    ...
                    switch (i = lr(
                        ...
                        case "s":
                            ...
                            return null != i.precision || isNaN(o = Lv(c, s)) || (i.precision = o),
                            t.formatPrefix(i, s);
                        case "":
                        case "e":
                        case "g":
                        case "p":
                        case "r":
                            null != i.precision || isNaN(o = Rv(c, Math.max(Math.abs(u), Math.abs(a)))) || (
                                i.precision = o - ("e" === i.type)
                            );
                            break;
                        case "f":
                        case "%":
                            null != i.precision || isNaN(o = Pv(c)) || (
            ...
            var sx = cx.range,
                ...
                Cx = Zu(function (t) {
                    ...
                    return n.getUTCMonth() - t.getUTCMonth() + 12 * (
                        n.getUTCFullYear() - t.getUTCFullYear()
                    )
                }, function (t) {
            ...
            var Fx = Date.prototype.toISOString
                ...
                Ix = +new Date("2000-01-01T00:00:00.000Z")
                    ? Ja
                ...
                $x = 365 * Hx,
                Wx = function () {
                    return tc(cx, ux, Vm, Hm, Bm, Im, Om, Rm, t.timeFormat).domain([
                        new Date(2e3, 0, 1),
                        new Date(2e3, 0, 2)
                    ])
                },
                Zx = function () {
                    return tc(Px, Cx, _x, dx, hx, fx, Om, Rm, t.utcFormat).domain([
                        Date.UTC(2e3, 0, 1),
                        Date.UTC(2e3, 0, 2)
                    ])
                },
                ...
                ob = function (t) {
                    ...
                    var n = Math.abs(t - .5);
                    return ib.h = 360 * t - 100,
                    ib.s = 1.5 - 1.5 * n,
                    ib.l = .8 - .9 * n,
                    ib + ""
                },
                ub = nc(Gx(
                    "44015444025645045745055946075a46085c460a5d460b5e470d60470e61471063471164471365" +
                ...
                ab = nc(Gx(
                    "00000401000501010601010802010902020b02020d03030f03031204041405041606051806051a" +
                ...
                cb = nc(Gx(
                    "00000401000501010601010802010a02020c02020e03021004031204031405041706041907051b" +
                ...
                sb = nc(Gx(
                    "0d088710078813078916078a19068c1b068d1d068e20068f2206902406912605912805922a0593" +
                ...
                wb = function () {
                    function t() {
                        var t,
                            ...
                            d = lb(p - h),
                            v = p > h;
                        if (c || (c = t = Re()), l < f && (s = l, l = f, f = s), l > yb) 
                            if (d > bb - yb) 
                                c.moveTo(l * pb(h), l * _b(h)),
                                c.arc(0, 0, l, h, p, !v),
                                f > yb && (c.moveTo(f * pb(p), f * _b(p)), c.arc(0, 0, f, p, h, v));
                            else {
                                var _,
                                    g,
                                    y = h,
                                ...
                                M > yb
                                    ? E > yb
                                        ? (
                                            ...
                                            E < S
                                                ? c.arc(_.cx, _.cy, E, hb(_.y01, _.x01), hb(g.y01, g.x01), !v)
                                                : (
                                                    c.arc(_.cx, _.cy, E, hb(_.y01, _.x01), hb(_.y11, _.x11), !v),
                                                    c.arc(0, 0, l, hb(
                                                        _.cy + _.y11,
                                                        _.cx + _.x11
                                                    ), hb(g.cy + g.y11, g.cx + g.x11), !v),
                                                    c.arc(g.cx, g.cy, E, hb(g.y11, g.x11), hb(g.y01, g.x01), !v)
                                                )
                                        )
                                ...
                                f > yb && w > yb
                                    ? N > yb
                                        ? (
                                            ...
                                            N < S
                                                ? c.arc(_.cx, _.cy, N, hb(_.y01, _.x01), hb(g.y01, g.x01), !v)
                                                : (
                                                    c.arc(_.cx, _.cy, N, hb(_.y01, _.x01), hb(_.y11, _.x11), !v),
                                                    c.arc(0, 0, f, hb(
                                                        _.cy + _.y11,
                                                        _.cx + _.x11
                                                    ), hb(g.cy + g.y11, g.cx + g.x11), v),
                                                    c.arc(g.cx, g.cy, N, hb(g.y11, g.x11), hb(g.y01, g.x01), !v)
                                                )
                                        )
                                        : c.arc(0, 0, f, b, x, v)
                                    : c.lineTo(L, R)
                ...
                kb = function () {
                    function t(t) {
                        ...
                        for (null == a && (s = c(p = Re())), n = 0; n <= d; ++n) {
                            ...
                            v && (_[n] = +e(h, n, t), g[n] = +i(h, n, t), s.point(
                                r
                                    ? +r(h, n, t)
                                    : _[n],
                                o
            ...
            var Cb = function () {
                ...
                Wb = {
                    draw: function (t, n) {
                        ...
                        t.lineTo(o, u),
                        t.lineTo(a, c),
                        t.lineTo(Hb * r - Xb * i, Xb * r + Hb * i),
                        t.lineTo(Hb * o - Xb * u, Xb * o + Hb * u),
                        t.lineTo(Hb * a - Xb * c, Xb * a + Hb * c),
                        t.lineTo(Hb * r + Xb * i, Hb * i - Xb * r),
                        t.lineTo(Hb * o + Xb * u, Hb * u - Xb * o),
                        t.lineTo(Hb * a + Xb * c, Hb * c - Xb * a),
                        t.closePath()
                    }
                },
                Zb = [
                ...
                point: function (t, n) {
                    ...
                    if (t = +t, n = +n, t !== this._x1 || n !== this._y1) {
                        switch (this._point) {
                            ...
                            case 2:
                                this._point = 3,
                                qc(this, Rc(this, e = Lc(this, t, n)), e);
                                break;
                            default:
                ...
                lineEnd: function () {
                    ...
                    if (e) 
                        if (
                            ...
                            for (var r = Bc(t), i = Bc(n), o = 0, u = 1; u < e; ++o, ++u) 
                                this
                                    ._context
                                    .bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
            ...
            Gc.prototype = {
                ...
                insert: function (t, n) {
                    ...
                    if (t) {
                        ...
                        this._
                            ? (t = ts(this._), n.P = null, n.N = t, t.P = t.L = n, e = t)
                    ...
                    for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) 
                        ...
                        e === r.L
                            ? (
                                ...
                                i && i.C
                                    ? (e.C = i.C = !1, r.C = !0, t = r)
                                    : (t === e.R && (Qc(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Kc(this, r))
                            )
                            : (
                                i = r.L,
                                i && i.C
                                    ? (e.C = i.C = !1, r.C = !0, t = r)
                                    : (t === e.L && (Kc(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Qc(this, r))
                            ),
                        e = t.U;
                    this._.C = !1
                },
                    ...
                    if (
                        ...
                        do {
                            ...
                            if (t === i.L) {
                                if (
                                    n = i.R,
                                    n.C && (n.C = !1, i.C = !0, Qc(this, i), n = i.R),
                                    n.L && n.L.C || n.R && n.R.C
                                ) {
                                    n.R && n.R.C || (n.L.C = !1, n.C = !0, Kc(this, n), n = i.R),
                                    n.C = i.C,
                                    i.C = n.R.C = !1,
                                    Qc(this, i),
                                    t = this._;
                                ...
                                n = i.L,
                                n.C && (n.C = !1, i.C = !0, Kc(this, i), n = i.L),
                                n.L && n.L.C || n.R && n.R.C
                            ) {
                                n.L && n.L.C || (n.R.C = !1, n.C = !0, Qc(this, n), n = i.L),
                                n.C = i.C,
                                i.C = n.L.C = !1,
                                Kc(this, i),
                                t = this._;
                            ...
                            if (o = (i = e.halfedges).length) 
                                for (
                                    ...
                                    f = s.left === a
                                        ? s.right
                                        : s.left,
                                    u && f && r < u.index && r < f.index && Ms(a, u, f) < 0 && t.push(
                                        [a.data, u.data, f.data]
                                    )
                        }),
                    t
                },
            ...
            var Pw = function () {
                    function t(t) {
                        return new ks(t.map(function (r, i) {
                            var o = [
                                Math.round(n(r, i, t) / Cw) * Cw,
                                Math.round(e(r, i, t) / Cw) * Cw
                            ];
                            return o.index = i,
                            o.data = r,
                            o
            ...
            Ns.prototype = {
                ...
                scale: function (t) {
                    return 1 === t
                        ? this
                        : new Ns(this.k * t, this.x, this.y)
                },
                translate: function (t, n) {
                    return 0 === t & 0 === n
                        ? this
                        : new Ns(this.k, this.x + this.k * t, this.y + this.k * n)
                },
                apply: function (t) {
                    return [
                        t[0] * this.k + this.x,
            ...
            var qw = function () {
                ...
                Uw = function () {
                    ...
                    function e(t, n) {
                        return n = Math.max(x, Math.min(b, n)),
                        n === t.k
                            ? t
                            : new Ns(n, t.x, t.y)
                    }
                    ...
                    function i(t, n) {
                        ...
                        return t.translate(
                            r > e
                                ? (e + r) / 2
                                : Math.min(0, e) || Math.max(0, r),
                            o > i
                                ? (i + o) / 2
                                : Math.min(0, i) || Math.max(0, o)
                        )
                    }
                    function o(t) {
                        return [
                    ...
                    function s() {
                        ...
                        if (y.apply(this, arguments)) {
                            var o = a(this, arguments),
                                u = this.__zoom,
                                c = Math.max(x, Math.min(b, u.k * Math.pow(2, -t.event.deltaY * (
                                    t.event.deltaMode
                                        ? 120
                                        : 1
                                ) / 500))),
                    ...
                    function f() {
                        function n() {
                            ...
                            o.zoom(
                                "mouse",
                                i(r(o.that.__zoom, o.mouse[0] = Ff(o.that), o.mouse[1]), o.extent)
                            )
                        }
                        function e() {
                            u.on("mousemove.zoom mouseup.zoom", null),
                            gt(t.event.view, o.moved),
                            qw(),
                            o.end()
                        }
                    ...
                    function h() {
                        if (y.apply(this, arguments)) {
                            ...
                            if (_ && (_ = clearTimeout(_), !o.touch1)) 
                                return o.end(),
                                void((i = bl(this).on("dblclick.zoom")) && i.apply(this, arguments));
                    ...
                    function p() {
                        var n,
                            ...
                            l = f.length;
                        for (qw(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n) 
                            o = f[n],
                            u = Ml(this, f, o.identifier),
                    ...
                    n.translateExtent = function (t) {
                        return arguments.length
                            ? (w = +t[0][0], M = +t[1][0], T = +t[0][1], k = +t[1][1], n)
                            : [
                                [
                                    w, T
                                ],
            ...
            t.extent = Hs,
            t.histogram = ef,
            t.thresholdFreedmanDiaconis = of,
            t.thresholdScott = uf,
            t.thresholdSturges = nf,
            t.max = af,
            t.mean = cf,
            t.median = sf,
            t.merge = ff,
            ...
            t.easeCircleIn = ve,
            t.easeCircleOut = _e,
            t.easeCircleInOut = ge,
            t.easeBounce = me,
            t.easeBounceIn = ye,
            t.easeBounceOut = me,
            t.easeBounceInOut = xe,
            t.easeBack = $p,
            t.easeBackIn = Xp,
            t.easeBackOut = Vp,
            t.easeBackInOut = $p,
            ...
            t.easeElasticIn = Zp,
            t.easeElasticOut = Gp,
            t.easeElasticInOut = Jp,
            t.forceCenter = $d,
            t.forceCollide = lv,
            t.forceLink = hv,
            t.forceManyBody = _v,
            t.forceSimulation = vv,
            t.forceX = gv,
            t.forceY = yv,
            ...
            t.geoAlbers = ay,
            t.geoAlbersUsa = cy,
            t.geoAzimuthalEqualArea = fy,
            t.geoAzimuthalEqualAreaRaw = sy,
            t.geoAzimuthalEquidistant = hy,
            t.geoAzimuthalEquidistantRaw = ly,
            t.geoConicConformal = dy,
            t.geoConicConformalRaw = lo,
            t.geoConicEqualArea = uy,
            t.geoConicEqualAreaRaw = io,
            t.geoConicEquidistant = _y,
            t.geoConicEquidistantRaw = po,
            t.geoEquirectangular = vy,
            ...
            t.geoMercator = py,
            t.geoMercatorRaw = co,
            t.geoOrthographic = my,
            t.geoOrthographicRaw = go,
            t.geoStereographic = xy,
            t.geoStereographicRaw = yo,
            t.geoTransverseMercator = by,
            ...
            t.treemapDice = Iy,
            t.treemapSlice = $y,
            t.treemapSliceDice = Qy,
            t.treemapSquarify = Zy,
            t.treemapResquarify = Ky,
            t.interpolate = Th,
            t.interpolateArray = gh,
            t.interpolateBasis = lh,
            t.interpolateBasisClosed = hh,
            t.interpolateDate = yh,
            t.interpolateNumber = mh,
            t.interpolateObject = xh,
            t.interpolateRound = kh,
            t.interpolateString = Mh,
            t.interpolateTransformCss = Ah,
            t.interpolateTransformSvg = Ch,
            t.interpolateZoom = Ph,
            t.interpolateRgb = dh,
            t.interpolateRgbBasis = vh,
            t.interpolateRgbBasisClosed = _h,
            t.interpolateHsl = Lh,
            t.interpolateHslLong = Rh,
            t.interpolateLab = ln,
            t.interpolateHcl = qh,
            ...
            t.path = Re,
            t.polygonArea = tm,
            t.polygonCentroid = nm,
            t.polygonHull = rm;
            t.polygonContains = im,
            t.polygonLength = om,
            t.quadtree = er,
            t.queue = yu,
            t.randomUniform = cm,
            t.randomNormal = sm,
            t.randomLogNormal = fm,
            t.randomBates = hm,
            t.randomIrwinHall = lm,
            t.randomExponential = pm,
            t.request = dm,
            t.html = _m,
            t.json = gm,
            t.text = ym,
            ...
            t.scaleTime = Wx,
            t.scaleUtc = Zx,
            t.schemeCategory10 = Jx,
            t.schemeCategory20b = Qx,
            t.schemeCategory20c = Kx,
            t.schemeCategory20 = tb,
            t.interpolateCubehelixDefault = nb,
            t.interpolateRainbow = ob,
            t.interpolateWarm = eb,
            t.interpolateCool = rb,
            t.interpolateViridis = ub,
            t.interpolateMagma = ab,
            t.interpolateInferno = cb,
            t.interpolatePlasma = sb,
            t.scaleSequential = ec,
            t.creator = Af,
            t.local = b,
            t.matcher = Rf,
            t.mouse = Ff,
            ...
            t.symbolTriangle = jb,
            t.symbolWye = Wb,
            t.curveBasisClosed = Kb,
            t.curveBasisOpen = tw,
            t.curveBasis = Qb,
            t.curveBundle = nw,
            t.curveCardinalClosed = rw,
            t.curveCardinalOpen = iw,
            t.curveCardinal = ew,
            t.curveCatmullRomClosed = uw,
            t.curveCatmullRomOpen = aw,
            t.curveCatmullRom = ow,
            ...
            t.curveStep = fw,
            t.curveStepAfter = Xc,
            t.curveStepBefore = Hc,
            t.stack = dw,
            t.stackOffsetExpand = vw,
            t.stackOffsetNone = hw,
            t.stackOffsetSilhouette = _w,
            t.stackOffsetWiggle = gw,
            t.stackOrderAscending = yw,
            t.stackOrderDescending = mw,
            t.stackOrderInsideOut = xw,
            t.stackOrderNone = pw,
            t.stackOrderReverse = bw,
            t.timeInterval = Zu,
            t.timeMillisecond = Rm,
            t.timeMilliseconds = qm,
            t.utcMillisecond = Rm,
            t.utcMilliseconds = qm,
            t.timeSecond = Om,
            t.timeSeconds = Fm,
            t.utcSecond = Om,
            t.utcSeconds = Fm,
            ...
            t.utcYear = Px,
            t.utcYears = Rx,
            t.timeFormatDefaultLocale = Za,
            t.timeFormatLocale = na,
            t.isoFormat = Fx,
            t.isoParse = Ix,
            t.now = dn,
            t.timer = gn,
